...
class AudioServer(MCPServer):
    ...
    async def _auto_stop_recording(self, duration: float):
        ...
        if self.is_recording:
            await self.stop_recording(MCPRequest(
                id="auto_stop",
            ...
            for i in range(self.audio.get_device_count()):
                ...
                if device_info['maxInputChannels'] > 0:
                    devices.append({
                        ...
                        "default": i == self.audio.get_default_input_device_info()['index']
                    })
                if device_info['maxOutputChannels'] > 0:
                    devices.append({
                        ...
                        "default": i == self.audio.get_default_output_device_info()['index']
                    })
